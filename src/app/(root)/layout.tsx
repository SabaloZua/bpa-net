      ...
      <div className="lg:col-span-3 flex flex-col overflow-hidden bg-white ">
          ...
          <div className="flex items-center justify-between p-4">
            ...
            <div className="flex items-center">
              <Link href={""} className="p-1 rounded-full text-gray-400 hover:text-gray-500 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-teal-500">
          ...
          <div className="px-4 py-2 border-t  flex items-center">
            <div className="mr-4">Olá <span className="font-medium text-blue-500">Sablo Zua</span>👋</div>
          </div>
        </header>
